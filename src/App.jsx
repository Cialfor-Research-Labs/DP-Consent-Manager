...
const MainAppContent = () => {
  ...
  // Check if viewing a specific token request link directly
  const pathname = window.location.pathname;
  const isDirectTokenRequest = Boolean(
  ...
  // If not authenticated and not accessing an explicit token link, show AuthView
  if (!isAuthenticated && !isDirectTokenRequest) {
    return <AuthView />;
  }
